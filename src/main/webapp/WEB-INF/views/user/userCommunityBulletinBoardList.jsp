...
<div class="content subPageContent">
	<div class="contentArea">
		<h2 class="subPageTitle">
			...
			<span class="subTit grayB"> | MuKKa人들의 아.무.말.대.잔.치</span>
		</h2>
		...
		<div class="RC_Area">
			<div class="RC_titleWrap clearfix">
				<h3 class="RC_title">오늘의 새로운 글 | <span class="red cafeRCnt">${todayCnt}개</span></h3>
				<div class="RC_topBtns">
					...
					<button class="navyBtn" id="RC_Register" style="cursor: pointer">새로운 글쓰기</button>
				</div>
			</div>
